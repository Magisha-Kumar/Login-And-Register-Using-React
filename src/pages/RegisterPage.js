	...
	const handleSubmit = (event) => {
		...
		if(!hasError){
			...
			RegisterApi(inputs).then((response)=>{
				...
				{
					setErrors({...errors,custom_error:"This email has already been registered"});
				}
						...
						<div className="col register-sec">
							...
							<form onSubmit={handleSubmit} className="register-form" action="" >
								<div className="form-group">
									...
									<input type="text" onChange={handleInputs} className="form-control" name="name" id=""  />
								...
								<div className="form-group">
									...
									<input type="text" onChange={handleInputs} className="form-control" name="email" id=""  />
								...
								<div className="form-group">
									...
									<input  className="form-control" onChange={handleInputs} type="password"  name="password" id="" />
